                    ...
                    <div class="card-body chat-body">
                        <div class="chat-box">
                            ...
                            <div class="chat-left-aside">
                                <div class="media"><img class="rounded-circle user-image" src="{{ asset('assets/images/user/12.png') }}"
                                        alt="">
                                    <div class="about">
                            ...
                            <div class="col pr-xl-0 chat-right-aside">
                                ...
                                <div class="chat">
                                    ...
                                    <div class="chat-header clearfix">
                                        <div class="media align-items-center"> <img class="rounded-circle"
                                                src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                                        ...
                                        <div class="row">
                                            <div class="col text-center pe-0 call-content">
                                                <div>
                                                    ...
                                                    <button class="btn btn-danger-gradien btn-block btn-lg">END
                                                        CALL</button>
                                            ...
                                            <div class="col-sm-7 ps-0 caller-img"><img class="img-fluid"
                                                    src="{{ asset('assets/images/other-images/caller.jpg') }}" alt=""></div>
                                        </div>
                                    </div>
                                    <!-- chat-history ends-->
                                    <!-- chat end-->
                                            ...
                                            <ul class="list">
                                                <li class="clearfix"><img class="rounded-circle user-image"
                                                    ...
                                                    <div class="about">
                                                        ...
                                                        <div class="status"><i class="fa fa-share font-success"></i>  5
                                                            May, 4:40 PM</div>
                                                    </div>
                                                </li>
                                                <li class="clearfix"><img class="rounded-circle user-image mt-0"
                                                    ...
                                                    <div class="about">
                                                        <div class="name">Vincent Porter</div>
                                                        <div class="status"><i class="fa fa-reply font-danger"></i>  5
                                                            May, 5:30 PM</div>
                                                    </div>
                                                </li>
                                                <li class="clearfix"><img class="rounded-circle user-image"
                                                    ...
                                                    <div class="about">
                                                        <div class="name">Kori Thomas</div>
                                                        <div class="status"><i class="fa fa-share font-success"></i>  1
                                                            Feb, 6:56 PM</div>
                                                    </div>
                                                </li>
                                                <li class="clearfix"><img class="rounded-circle user-image"
                                                    ...
                                                    <div class="about">
                                                        <div class="name">Aiden Chavez</div>
                                                        <div class="status"><i class="fa fa-reply font-danger"></i>  3
                                                            June, 1:22 PM</div>
                                                    </div>
                                                </li>
                                                <li class="clearfix"><img class="rounded-circle user-image"
