...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="knowledgebase-bg"><img class="bg-img-cover bg-center" src="{{ asset('assets/images/knowledgebase/bg_1.jpg') }}"
                        alt="looginpage"></div>
                                ...
                                <div class="row browse g-sm-4 g-3">
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles">
                                            ...
                                            <ul>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Lorem Ipsum is
                                                            simply dummy text of the printing</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Lorem Ipsum has
                                                            been the industry's standard dummy </span><span
                                                            class="badge badge-primary pull-right">New</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>When an unknown
                                                            printer took a galley </span></a></li>
                                                <li><a href="#"><span><i data-feather="file-text"></i></span><span>But
                                                            also the leap into electronic typesetting, </span></a></li>
                                                <li><a href="#"><span><i
                                    ...
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Normal
                                                            distribution of letters, as opposed to using </span><span
                                                            class="badge badge-primary pull-right">Closed</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Lorem Ipsum, you
                                                            need to be sure there isn't anything </span></a></li>
                                                <li><a href="#"><span><i
                                    ...
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles browse-bottom">
                                            ...
                                            <ul>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Nemo enim ipsam
                                                            voluptatem quia voluptas sit </span><span
                                                            class="badge badge-primary pull-right">Popular</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Ipsum quia dolor
                                                            sit amet, consectetur</span></a></li>
                                                <li><a href="#"><span><i data-feather="file-text"></i></span><span>Sed
                                                            quia non numquam eius modi tempora incidunt</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Lorem eum fugiat
                                                            quo voluptas nulla pariatu</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="arrow-right"></i></span><span>See More
                                                            (90)</span></a></li>
                                            </ul>
                                    ...
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles browse-bottom">
                                            ...
                                            <ul>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Desktop
                                                            publishing software like Aldus PageMaker</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Etraset sheets
                                                            containing Lorem Ipsum passages</span></a></li>
                                                <li><a href="#"><span><i
                                    ...
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles browse-bottom">
                                            ...
                                            <ul>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>The point of
                                                            using Lorem Ipsum </span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>It has a
                                                            more-or-less normal distribution of letters</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Et harum quidem
                                                            rerum facilis est et expedita</span><span
                                    ...
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles browse-bottom">
                                            ...
                                            <ul>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>When our power of
                                                            choice is untrammelled </span><span
                                                            class="badge badge-primary pull-right">Review</span></a></li>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>It will
                                                            frequently occur that pleasures </span></a></li>
                                                <li><a href="#"><span><i
                                    ...
                                    <div class="col-xl-4 xl-50 col-md-6">
                                        <div class="browse-articles browse-bottom">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Ducimus
                                                            blanditiis praesentium voluptatum</span><span
                                                            class="badge badge-primary pull-right">Popular</span></a></li>
                                                <li><a href="#"><span><i
                                    ...
                                    <div class="col-xl-4 xl-100">
                                        <div class="browse-articles browse-bottom">
                                            ...
                                            <ul>
                                                <li><a href="#"><span><i
                                                                data-feather="file-text"></i></span><span>Lorem Ipsum
                                                            passage, and going through</span></a></li>
                                                <li><a href="#"><span><i
