            ...
            <div class="card balance-box">
              <div class="card-body">
                <div class="balance-profile">
                  <div class="balance-img"><img src="{{ asset('assets/images/dashboard-4/user.png') }}" alt="user vector"><a class="edit-icon" href="{{ route('user-profile')}}">
                      <svg>
                  ...
                  <table class="table table-bordernone">
                    <tbody>
                      <tr>
                        ...
                        <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Anna K.</a><span class="f-light">To : 0x187...12bb</span></td>
                        <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="{{ asset('assets/images/dashboard/user/12.jpg') }}" alt="user"></td>
                        <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Guy Hawkins</a><span class="f-light">To : 0x187...12bb</span></td>
                        <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="{{ asset('assets/images/dashboard/user/10.jpg') }}" alt="user"></td>
                        <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Jenny Wilson</a><span class="f-light">To : 0x187...12bb</span></td>
                        <td class="text-end"> <span class="font-danger">-0.1BNB</span><span class="d-block f-light">29.09.22</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="{{ asset('assets/images/dashboard/user/11.jpg') }}" alt="user"></td>
                        <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Jacob B.</a><span class="f-light">To : 0x187...12bb</span></td>
                        <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="{{ asset('assets/images/dashboard/user/13.jpg') }}" alt="user"></td>
                        <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Esther Howard</a><span class="f-light">To : 0x187...12bb</span></td>
                      ...
                      <tr>
                        ...
                        <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Leslie Alexander</a><span class="f-light">To : 0x187...12bb</span></td>
                        <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                      </tr>
                    </tbody>
                  </table>
