    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                ...
                                <div class="dropdown-menu"><a class="dropdown-item" id="profile-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">Action</a><a class="dropdown-item" href="#">Another
                                        action</a><a class="dropdown-item" href="#">Something else here</a><a
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3 col-xs-12">
                                <div class="nav flex-column nav-pills nav-primary" id="v-pills-tab" role="tablist"
            ...
            <div class="col-sm-12 col-xxl-6">
                <div class="card height-equal">
                    <div class="card-header">
                        <h5>Pill Dark color</h5><span>Add <code>.nav-*</code> class with nav class</span><span>remove
