     ...
     <div class="row">
       ...
       <div class="col-xl-6">
         <div class="card">
           ...
           <div class="card-body avatar-showcase">
             <div class="avatars">
               <div class="avatar ratio"><img class="b-r-8 img-100" src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></div>
               <div class="avatar ratio"><img class="b-r-8 img-90" src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></div>
               <div class="avatar ratio"><img class="b-r-8 img-80" src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></div>
               <div class="avatar ratio"><img class="b-r-8 img-70" src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></div>
               <div class="avatar ratio"><img class="b-r-8 img-60" src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></div>
               <div class="avatar ratio"><img class="b-r-8 img-50" src="{{ asset('assets/images/user/1.jpg') }}" alt="#"></div>
             </div>
           </div>
         </div>
       </div>
